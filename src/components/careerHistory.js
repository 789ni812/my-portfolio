            ...
            >
              ...
              >
                <Box textAlign="left" m={1}>
                  <Typography display={"block"} gutterBottom={true}>
                    <span className={classes.secondaryHeading}>Company: </span>
                    {post.companyName}
                  </Typography>
                  {post.companysite ? (
                    <Typography gutterBottom={true}>
                      <span className={classes.secondaryHeading}>URL: </span>{" "}
                      <a href={post.companySite}>{post.companySite}</a>
                    </Typography>
                  ) : (
                    ""
                  )}
                  <Typography gutterBottom={true}>
                    <span className={classes.secondaryHeading}> Role: </span>
                    {post.role}
                  </Typography>
                  <Typography gutterBottom={false}>
                    <span className={classes.secondaryHeading}>Duration: </span>
                    <Moment ago from={post.endDateUS}>
                      {post.startDateUS}
                    </Moment>
                  </Typography>
                  {post.teaser ? (
                  ...
                  <Card key={post.id}>
                    <CardContent>
                      <Typography variant="caption" color="textSecondary">
                        Start date:{" "}
                        <Moment format="DD-MM-YYYY">{post.startDateUS}</Moment>{" "}
                        | End date:{" "}
                        <Moment format="DD-MM-YYYY">{post.endDateUS}</Moment>
                      </Typography>
                    </CardContent>
                    ...
                    {post.teamsWorkedWith ? (
                      <CardContent>
                        <Typography variant="body2" color="textPrimary">
                          <h3>
                            Worked closely with co-located teams from locations
                            such as:
                          </h3>
                          <Grid container spacing={2}>
