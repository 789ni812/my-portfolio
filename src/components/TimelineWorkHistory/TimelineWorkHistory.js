              ...
              <VerticalTimeline>
                ...
                >
                  ...
                  <Typography variant="body1" className={classes.textPCurrent}>
                    Currently availble for work, In the meantime I'm working on
                    a few React based projects to keep the engineering oil
                    flowing
                  </Typography>
                </VerticalTimelineElement>
                <VerticalTimelineElement
                ...
                >
                  ...
                  <Typography variant="body1">
                    Led on Drupal (and other) CMS / technology client
                    deliveriables.
                  </Typography>
                  <Typography variant="body1">
                    Worked directly with clients to manage scope, planning,
                    delivery and maintenance of multiple projects
                  </Typography>
                  <Typography variant="body1">
                ...
                >
                  ...
                  <p className={classes.textP}>
                    Responsible for the smooth running of multiple client
                    projects, working closely with clients, stakeholders and
                    developers to ensure agile projects and budgets are on
                    track. A varied role requiring a strong technical
                    background, good communication skills and a heavy focus on
                    agile principles.
                  </p>
                  <Typography variant="body1">
                ...
                >
                  ...
                  <Typography variant="body1">
                    Grew the project management function for one of the UK’s
                    fastest growing start-ups in the self-tracking and
                    healthcare space (2015)
                  </Typography>
                  <Typography variant="body1">
                    Accountable for the successful management of
                    multi-disciplinary teams to customise and deliver
                ...
                >
                  ...
                  <Typography variant="body1">
                    ...
                    methodologies. Migrated around 30+ websites over to the
                    (then new) Drupal 7 platforms with improved subscription and
                ...
                >
                  ...
                  <Typography variant="body1">
                    Successful hiring of a new global marketing web team in
                    Prague, focusing on optimizing the global web presence,
                    revenue and user experience. Working closely with the CEO
                    and VP of marketing. managing a team of developers,
                    designers, copywriters and marketing specialists to shape a
                    centre of excellence for the web.
                  </Typography>
                  <Typography variant="body1">
                    Accountable for the successful rebrand and continuous
                    rollout AVG's global web platforms
                  </Typography>
                </VerticalTimelineElement>
                <VerticalTimelineElement
                  data-test="dt-LGT"
                ...
                >
                  ...
                  <Typography variant="body1">
                    ...
                    development processes to tight budgets and timelines. Manage
                    all servers and IT infrastructure.
                  </Typography>
                </VerticalTimelineElement>
                <VerticalTimelineElement
                ...
                >
                  ...
                  <Typography variant="body1">
                    ...
                    finance sites in the UK, powering several finance portals
                    for companies such as Financial Times and The Independent.
                  </Typography>
                </VerticalTimelineElement>
                <VerticalTimelineElement
                ...
                >
                  ...
                  <Typography variant="body1">
                    Web developer to help maintain current website alongside a
                    team of journalists and coders.
                  </Typography>
                </VerticalTimelineElement>
                <VerticalTimelineElement
                  data-test="dt-Unreal"
