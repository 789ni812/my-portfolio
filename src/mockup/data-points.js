...
export const CareerHistory = [
    ...
    },
    {
        ...
        shortDescription: 'Worked closely with the managing director to help grow the London Ensemble office from 4 to 20+ staff while managing projects from multiple clients.<br/><br/> A varied role required a can do atitude, a technical background, an ability to communicate well and an attention to detail',
